...
+=================================================+
|DASCHUND                                         |
|Wider Epigenomic Context Window via repetition   |
|                                                 |
|-------------------------------------------------|
|A2. Keyhold Image + Histogram + Epigenomic-5bin  |
|                                                 |
|    Repeat the epigenomic intervals 12x          |
|    To amplify their role in the embedding       |
|    Adjust as needed. WIP                        |
|                                                 |
|    Use with Epi@1, 5, and 11 bins. A1 is 1bin   |
|                                                 |
|-------------------------------------------------|
|                                                 |
+–––––––––––––––––––––––––––––––––––––––––––––––––+
...
def mainProg():
    ...
    # dbVECTOR = "debug.db"
    dbVECTOR = "/Users/sean/Documents/Master/2025/March2025/Daschund/ebTable/B2_llama3.2-3B-KHI-hist_epi5bin_R20.db"
